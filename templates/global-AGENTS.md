...
## 11. Workflow
Project workflow files and installed workflow skills own role topology, phase gates, review,
continuation, and closure. Follow them when present; do not reconstruct or duplicate their
protocol in this global file.
