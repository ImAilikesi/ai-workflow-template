---
name: commandcode-handoff
description: Transfer one verified Command Code workflow checkpoint to a continuation in the same phase and role lineage.
---

# Command Code-native handoff
...
- Label it `<Phase> · Command Code · <Role> · C<N>`.
